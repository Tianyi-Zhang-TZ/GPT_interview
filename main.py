...
def phrase_questions(transcripts,meta,question_tpye,dataset,info):
	...
	for i in range(len(transcripts)):
		...
		text = question(transcript,meta,question_tpye,dataset,info)
...
def main(question_tpye,dataset,infor,model_name):
	folder_name = "output_data/%s/answers_%s_%s_%s/"%(model_name,dataset,question_tpye,"infor" if infor else "noninfor")
...
if __name__ == "__main__":	
	...
	for question_tpye in question_tpyes:
		...
		q = pickle.load(f)
		f.close()
		main(question_tpye,dataset,info,model_name)
	'''
	dataset = "opva"
